...
发布文件夹内的所有视频
python cli_main.py douyin account_name upload -d /path/to/video/folder

定时发布文件夹中的视频
python cli_main.py douyin account_name upload -d /path/to/video/folder -pt 1 -t "2024-03-20 14:30"
```
